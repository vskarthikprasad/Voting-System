...
if (mysqli_num_rows($sql) >0 ) {
	...
	$error = "<center><h4><font color='#FF0000'>Incorrect Voter ID or Password</h4></center></font>";
	include "login.php";
}
}
else {
	$error = "<center><h4><font color='#FF0000'>Invalid Voter ID or Password</h4></center></font>";
	include "login.php";
}
?>